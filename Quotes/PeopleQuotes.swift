    ...
    init (i: Int){
        ...
        case 3 :
            ...
            quotes = ["Walking is the best possible exercise. Habituate yourself to walk very far.",
                ...
                "Our greatest happines does not depend on the condition of life in which chance has placed us, but is always the result of a good conscience, good health, occupation, and freedom in all just pursuits.",
...
/*
//Will Smith
quotes = [ "Being realistic is the most commonly traveled road to mediocrity.",
